...
echo "==================================================================="
echo "Rspack [fullhash] Bug Reproduction"
echo "==================================================================="
echo ""
...
if [ "$BUILD1_FULLHASH" = "$BUILD2_FULLHASH" ]; then
  ...
  echo "     (Expected: should change because build output changed)"
  echo ""
  echo "🐛 BUG CONFIRMED!"
  echo "   CSS content changed, but [fullhash] stayed the same."
  echo "   This means different build outputs have identical fullhashes."
else
